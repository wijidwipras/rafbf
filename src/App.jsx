  ...
  return (
    <>
      ...
      <div className="h-screen bg-primaryColor bg-ornamentBox bg-no-repeat bg-cover px-3 md:px-[51px] duration-300">
        ...
        <div className="navbar text-white hover:text-white/80">
          <div className="navbar-start">
            <div className="dropdown">
              ...
              <ul
                tabIndex={0}
                className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 text-primaryColor">
                <li>
            ...
            <div className="flex items-center gap-2">
              ...
              <a src="#" className="normal-case text-xl font-bold italic">
                RAFBF
              </a>
            </div>
          </div>
          ...
          <div className="navbar-end">
            <a
              href="https://wa.me/081913594086"
              className="btn bg-mainGrad border-none rounded-full text-white px-6 py-4 capitalize">
              Hubungi Kami
            </a>
          </div>
        </div>
        ...
        <div className="h-[80vh] flex flex-col justify-between">
          ...
          <div className="flex flex-col items-center text-white">
            <h1 className="text-4xl sm:text-6xl text-center font-extrabold text-transparent bg-clip-text bg-gradient-to-r to-[#00796D] from-[#38C682] leading-[50px] sm:leading-[70px]">
              Breeding Puter
            </h1>
            <h1 className="text-4xl sm:text-6xl text-center font-extrabold text-white mb-2">
              Pelung Nusantara
            </h1>
            <p className="w-full sm:w-[50%] text-center">
              Kami berkomitmen untuk menjaga populasi burung Puter Pelung dan
              mempromosikan pelestarian alam serta pelestarian keanekaragaman
              hayati
            </p>
          </div>
          ...
          <div className="flex justify-center">
            <a
              href="https://wa.me/081913594086"
              className="btn bg-mainGrad border-none rounded-full text-white capitalize my-2">
          ...
          {/* poin hero */}
          <div className="flex justify-center">
            <div className="product bg-mainGrad h-[200px] w-fit px-20 rounded-[20px] flex justify-start gap-20 items-center overflow-x-auto snap-x snap-mandatory">
      ...
      <div className="relative bg-secondGrad px-3 md:px-[51px] mt-[70px] pt-[70px] pb-[90px]">
        ...
        <h1 className="mb-[16px] text-6xl text-center font-extrabold leading-[70px]">
          Alur{" "}
          <span className="text-transparent bg-clip-text bg-gradient-to-r to-[#00796D] from-[#38C682]">
            Budidaya
          </span>
        </h1>
        <p className="mb-[45px] text-center w-full sm:w-[60%] mx-auto">
          Produk-produk ini dibuat dengan perhatian terhadap detail untuk
          memastikan keamanan dan kesejahteraan burung anda
        </p>

        <div className="relative w-full h-full flex flex-col sm:flex-row justify-around items-center">
          <div className="absolute w-full h-full flex justify-center items-center">
            <div className="border-dashed border border-gray-500 h-0 w-[80%] hidden sm:block"></div>
          </div>

          <div className="flex z-10 flex-col justify-center items-center">
            <div
              className="h-[100px] w-[100px] bg-whiteGrad rounded-full flex justify-center items-center mb-3 tooltip tooltip-right sm:tooltip-bottom tooltip-close md:tooltip-open"
              data-tip="Persiapan Kandang">
      ...
      <div
        id="produk"
        className="bg-primaryColor bg-ornamentBox2 bg-bottom bg-no-repeat bg-cover pt-[70px] pb-[51px]">
        <h1 className="text-white text-6xl text-center font-extrabold leading-[70px] mb-5">
          Produk Penawaran{" "}
          <span className="text-transparent bg-clip-text bg-gradient-to-r to-[#00796D] from-[#38C682]">
            Khusus
          </span>
        </h1>
        <p className="w-full sm:w-[70%] mx-auto text-white text-center">
          Kami berkomitmen untuk menjaga populasi burung Puter Pelung dan
          mempromosikan pelestarian alam serta pelestarian keanekaragaman hayati
        </p>
        ...
        <div className="product w-[99%] mx-auto flex overflow-x-auto snap-x scroll-pl-6 snap-mandatory gap-3 mt-11">
          <div className="snap-start flex-shrink-0 card w-96 bg-[#181D2A] border-[1px] border-[#3D414C] shadow-sm text-white ml-1 md:ml-6">
            <figure className="p-[10px]">
              <img
                src={PBurungAnggunan}
                alt="Burung Anggunan"
                className="rounded-xl w-[414px] h-[400px] object-cover"
              />
            </figure>
          ...
          <div className="snap-start flex-shrink-0 card w-96 bg-[#181D2A] border-[1px] border-[#3D414C] shadow-sm text-white">
            <figure className="p-[10px]">
              <img
                src={PKonsultasi}
                alt="Pelayanan Konsultasi Burung"
                className="rounded-xl w-[414px] h-[400px] object-cover"
              />
            </figure>
            <div className="card-body items-center sm:items-start text-center p-[10px]">
      ...
      <div
        id="legalitas"
        className="relative bg-secondGrad px-3 md:px-[51px] py-[70px]">
        <div className="absolute w-[100px] h-[100px] bg-emerald-600/30 rounded-full left-2 top-2 -z-10"></div>
        <img src={ornamentLine} className="absolute right-2 bottom-2" alt="" />
        ...
        <div className="flex flex-col-reverse sm:flex-row  gap-11 items-center">
          ...
          <div className="">
            <h1 className="text-6xl mb-8 text-center sm:text-start font-extrabold leading-[70px]">
              Legalitas{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r to-[#00796D] from-[#38C682]">
                Usaha
              </span>
            ...
            <p className="text-center sm:text-start">
              Memastikan bahwa kepemilikan aset perusahaan, termasuk merek
              dagang, paten, dan hak cipta, sesuai dengan hukum adalah bagian
              dari legalitas usaha
            </p>
          </div>
        </div>
      </div>
      ...
      <div id="mitra" className="px-3 md:px-[51px] py-[70px]">
        <h1 className="text-4xl sm:text-6xl mb-4 text-center md:text-left font-extrabold leading-[50px] sm:leading-[70px] w-full md:w-[50%]">
        ...
        <p className="text-center md:text-left">
          Lihat bagaimana kami bekerja bersama mitra
        </p>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="flex w-fit flex-col mt-11">
            <div
              className={`btn block ${
                isMitra == 1 ? "bg-mainGrad text-white" : "btn-ghost "
              } border-none rounded-full py-4 capitalize mb-5 text-left`}
              onClick={handlePersebaran}>
              Persebaran Mitra Usaha
            </div>
            <div
              className={`btn block ${
                isMitra == 2 ? "bg-mainGrad text-white" : "btn-ghost "
              } border-none rounded-full py-4 capitalize mb-5 text-left`}
              onClick={handleMitra}>
              Mitra Usaha
            </div>
            <div
              className={`btn block ${
                isMitra == 3 ? "bg-mainGrad text-white" : "btn-ghost "
              } border-none rounded-full py-4 capitalize mb-5 text-left`}
              onClick={handlePerluasan}>
              Perluasan Mitra Usaha
            </div>
          </div>
          <div className="basis-1/2">
            <div
              className={`flex-col items-center ${
                isMitra == 1 ? "flex" : "hidden"
              }`}>
              <img src={Persebaran} alt="" />
              <h4 className="text-4xl font-extrabold leading-[70px] text-transparent bg-clip-text bg-gradient-to-r to-[#00796D] from-[#38C682]">
                Pulau Jawa
              </h4>
            </div>
            <div
              className={`flex-col items-start ${
                isMitra == 2 ? "flex" : "hidden"
              }`}>
              <h4 className="text-4xl font-extrabold leading-[50px] sm:leading-[70px] text-transparent bg-clip-text bg-gradient-to-r to-[#00796D] from-[#38C682]">
                Mitra Usaha
              </h4>
              <ul className="pl-6">
      ...
      <div className="bg-primaryColor text-white px-[51px]">
        <footer className="footer pb-[25px] pt-[70px]">
          <aside>
            ...
            <p>
              RAFBF Breeding Puter Pelung Nusantara Ltd.
              <br />
              Dawuhan Jatirejoso, Kab. Malang
            </p>
          </aside>
          <nav>
          ...
          <nav>
            ...
            <a
              href="https://www.instagram.com/rafbirdfarm_pelungnusantara/"
              className="link link-hover">
              Instagram
            </a>
            <a href="https://wa.me/081913594086" className="link link-hover">
              WhatsApp
            </a>
          </nav>
          <nav>
        ...
        <div className="border-t-[1px] border-gray-500 py-7">
          <p className="text-center">
            Copyright © 2023 by RAFBF. All rights reserved.
          </p>
        </div>
      </div>
      {/* end footer */}
