...
function App() {
  ...
  return (
    <>
        ...
        <div className="collapse collapse-arrow bg-base-200 mb-4 py-2">
          ...
          <div className="collapse-content">
            <div className="flex">
              ...
              <div className="w-[95%]">
                <p className='mt-4 mb-7'>Keberadaan burung dalam kehidupan kita bisa memberikan kegembiraan, ketenangan, dan keseimbangan. Namun, seringkali pemilik burung malah merasa terganggu dengan suara berisik dari burung peliharaannya</p>
        ...
        <div className="collapse collapse-arrow bg-base-200 mb-4 py-2">
          ...
          <div className="collapse-content">
            <div className="flex">
              <div className="w-[5%]"></div>
              <div className="w-[95%]">
                <p className='mt-4 mb-7'>Kurangnya minat generasi muda dalam minat memelihara burung Anggunan adalah masalah yang sering muncul dalam berbagai konteks. Untuk mengatasi masalah ini, perlu adanya pendekatan yang sesuai.</p>
        ...
        <div className="collapse collapse-arrow bg-base-200 mb-4 py-2">
          ...
          <div className="collapse-content">
            <div className="flex">
              <div className="w-[5%]"></div>
              <div className="w-[95%]">
                <p className='mt-4 mb-7'>Merawat burung peliharaan dengan baik adalah tanggung jawab yang serius, dan kurangnya pengetahuan atau perhatian yang tepat dapat mengakibatkan kesulitan dalam merawat burung hingga akhirnya mati.</p>
        ...
        <div className="collapse collapse-arrow bg-base-200 mb-4 py-2">
          ...
          <div className="collapse-content">
            <div className="flex">
              <div className="w-[5%]"></div>
              <div className="w-[95%]">
                <p className='mt-4 mb-7'>Ketika burung peliharaan Anda tidak sengaja terlepas dari sangkar, ini dapat menjadi situasi yang menegangkan. Hal ini perlu kehati-hatian dari pemilik burung.</p>
        ...
        <div className="collapse collapse-arrow bg-base-200 py-2">
          ...
          <div className="collapse-content">
            <div className="flex">
              <div className="w-[5%]"></div>
              <div className="w-[95%]">
                <p className='mt-4 mb-7'>Setiap jenis penyakit pada burung dapat memiliki tanda-tanda dan perawatan yang berbeda. Oleh karena itu, penting untuk berkonsultasi dengan pihak berpengalaman dalam merawat burung untuk mendapatkan diagnosis dan perawatan yang tepat.</p>
      ...
      {/* start alur budaya */}
      <div className="relative bg-secondGrad px-[51px] border-red-300 mt-[70px] pt-[70px] pb-[90px]">
        {/* ornament */}
        ...
        <p className='mb-[45px] text-center w-[60%] mx-auto'>Produk-produk ini dibuat dengan perhatian terhadap detail untuk memastikan keamanan dan kesejahteraan burung anda</p>
        ...
        <div className="w-[80%] mx-auto">
          <div className="relative w-full h-full flex justify-around items-center">
            ...
            <div className="flex z-10 flex-col justify-center items-center">
              <div className='h-[100px] w-[100px] bg-whiteGrad rounded-full flex justify-center items-center tooltip tooltip-bottom tooltip-open' data-tip="Persiapan Kandang">
            ...
            <div className="flex z-10 flex-col justify-center items-center">
              <div className='h-[100px] w-[100px] bg-whiteGrad rounded-full flex justify-center items-center tooltip tooltip-bottom tooltip-open' data-tip="Persiapan Indukan">
                <div className='h-[80px] w-[80px] border-4 border-emerald-700 rounded-full'>
            ...
            <div className="flex z-10 flex-col justify-center items-center">
              <div className='h-[100px] w-[100px] bg-whiteGrad rounded-full flex justify-center items-center tooltip tooltip-bottom tooltip-open' data-tip="Anakan">
                <div className='h-[80px] w-[80px] border-4 border-emerald-700 rounded-full'>
      ...
      <div id='legalitas' className="relative bg-secondGrad px-[51px] border-red-300 py-[70px]">
        ...
        <div className="flex gap-11 items-center">
          ...
          <div className="">
            ...
            <p>Memastikan bahwa kepemilikan aset perusahaan, termasuk merek dagang, paten, dan hak cipta, sesuai dengan hukum adalah bagian dari legalitas usaha</p>
          </div>
        </div>
      </div>
      {/* end legalitas */}
      ...
      <div id='mitra' className="px-[51px] py-[70px]">
        ...
        <div className="flex justify-between">
          <div className="flex w-fit flex-col mt-11">
            <div className={`btn block ${isMitra == 1 ? 'bg-mainGrad text-white' : 'btn-ghost '} border-none rounded-full px-6 py-4 capitalize mb-5 text-left`} onClick={handlePersebaran}>Persebaran Mitra Usaha</div>
            <div className={`btn block ${isMitra == 2 ? 'bg-mainGrad text-white' : 'btn-ghost '} border-none rounded-full px-6 py-4 capitalize mb-5 text-left`} onClick={handleMitra}>Mitra Usaha</div>
            <div className={`btn block ${isMitra == 3 ? 'bg-mainGrad text-white' : 'btn-ghost '} border-none rounded-full px-6 py-4 capitalize mb-5 text-left`} onClick={handlePerluasan}>Perluasan Mitra Usaha</div>
          </div>
          <div className="basis-1/2">
            ...
            <div className={`flex-col items-start ${ isMitra == 2 ? 'flex' : 'hidden' }`}>
              <h4 className='text-4xl font-extrabold leading-[70px] text-transparent bg-clip-text bg-gradient-to-r to-[#00796D] from-[#38C682]'>Mitra Usaha</h4>
              <ul className='pl-6'>
            ...
            <h4 className='text-4xl font-extrabold leading-[70px] text-transparent bg-clip-text bg-gradient-to-r to-[#00796D] from-[#38C682]'>Perluasan Mitra Usaha</h4>
              <ul className='pl-6'>
